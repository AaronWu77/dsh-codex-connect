...
function createOpenAICodexProfile(provider, fastMode, proxyManager, resolveProxyUrl, contextWindowOverrides, maxTokensOverrides, route = OPENAI_CODEX_PRIMARY_ROUTE) {
	const routedProvider = withOpenAICodexRouteId(applyOpenAICodexOverrides(provider, contextWindowOverrides, maxTokensOverrides), route.routeId);
	return {
...
*/
function createOpenAICodexAdapter(credentials, resolveAttachments, fastMode, visibleModelIds, proxyManager, resolveProxyUrl, contextWindowOverrides, maxTokensOverrides, routeBindings) {
	...
	const currentProfiles = () => {
		...
		if (profiles === void 0 || !deepEqualJson(previousKey, key)) {
			previousKey = key;
			profiles = new Map(bindings.map((route) => [route.routeId, createOpenAICodexProfile(provider, fastMode, proxyManager, resolveProxyUrl, windowOverrides, tokenOverrides, route)]));
		}
		return profiles;
	};
...
//#endregion
export { readInstalledPackageVersion as $, assertNoOpenAICodexProviderConflict as A, OpenAICodexTrustedOriginsStore as At, COMPATIBILITY_PACKAGES as B, OPENAI_CODEX_AUTH_DOCUMENT_LIMIT as Bt, OPENAI_CODEX_TRANSPORT_ERROR_CODES as C, resolveOpenAICodexProxyUrl as Ct, isOpenAICodexTransportError as D, OPENAI_CODEX_FAST_MODE_MAX_SESSIONS as Dt, OpenAICodexTransportError as E, FastModeRegistry as Et, checkForOpenAICodexUpdate as F, openAICodexModelCatalog as Ft, SUPPORTED_DSH_PLUGIN_API_VERSION as G, openAICodexAuthPath as Gt, DSH_PLUGIN_API_PACKAGES as H, OPENAI_CODEX_AUTH_V1_BACKUP_SUFFIX as Ht, compareOpenAICodexVersions as I, loginOpenAICodex as It, SUPPORTED_PI_AI_RANGE as J, SUPPORTED_DSH_PLUGIN_API_VERSIONS as K, OPENAI_CODEX_ACCOUNT_LIMIT as Kt, parseOpenAICodexUpdateResult as L, logoutOpenAICodex as Lt, openAICodexConflictMessage as M, OPENAI_CODEX_USAGE_URL as Mt, CODEX_CONNECT_VERSION as N, parseOpenAICodexUsage as Nt, VIEW_IMAGE_TOOL_NAME as O, OPENAI_CODEX_FAST_MODE_MAX_SESSION_ID_LENGTH as Ot, OPENAI_CODEX_UPDATE_PATH as P, readOpenAICodexRateLimits as Pt, isSupportedDshPluginApiVersion as Q, parseOpenAICodexVersion as R, openAICodexAuthStatus as Rt, OPENAI_CODEX_TRANSPORT_API_VERSION as S, normalizeOpenAICodexProxyUrl as St, OpenAICodexTransport as T, OPENAI_CODEX_FAST_MODE_PATH as Tt, PI_AI_PACKAGE as U, OPENAI_CODEX_PROVIDER as Ut, COMPATIBILITY_SCHEMA_VERSION as V, OPENAI_CODEX_AUTH_FILENAME as Vt, SUPPORTED_DSH_PLUGIN_API_RANGE as W, OpenAICodexCredentialStore as Wt, detectCompatibility as X, assessCompatibility as Y, evaluateCompatibility as Z, OPENAI_CODEX_IMAGE_MAX_COUNT as _, decodeOpenAICodexSettings as _t, name as a, OPENAI_CODEX_PROXY_PROBE_URL as at, OPENAI_CODEX_IMAGE_PROMPT_MAX_LENGTH as b, isValidOpenAICodexMaxTokensOverrides as bt, migrateOpenAICodexSearchHistory as c, listOpenAICodexProxyCandidates as ct, OPENAI_CODEX_BASE_URL as d, DEFAULT_OPENAI_CODEX_SEARCH_CONTEXT_SIZE as dt, OPENAI_CODEX_PROXY_DETECT_PATH as et, OPENAI_CODEX_SEARCH_PROVIDER as f, DEFAULT_OPENAI_CODEX_SEARCH_MAX_OUTPUT_TOKENS as ft, OPENAI_CODEX_IMAGE_GENERATION_URL as g, OPENAI_CODEX_SETTINGS_NAMESPACE as gt, mapOpenAICodexSearchResponse as h, DEFAULT_OPENAI_CODEX_SETTINGS as ht, inject as i, OPENAI_CODEX_PROXY_PROBE_TIMEOUT_MS as it, diagnoseOpenAICodex as j, normalizeTrustedOrigin as jt, IMAGE_GENERATE_TOOL_NAME as k, isFastModeSessionId as kt, CODEX_AUTO_REVIEW_MODEL as l, DEFAULT_OPENAI_CODEX_IMAGE_MODEL_HINT as lt, OpenAICodexSearchProvider as m, DEFAULT_OPENAI_CODEX_SEARCH_MODEL as mt, OPENAI_CODEX_SETTINGS_NS as n, OPENAI_CODEX_LOCAL_PROXY_CANDIDATES as nt, OPENAI_CODEX_HISTORY_BACKUP_SUFFIX as o, OpenAICodexProxyManager as ot, OPENAI_CODEX_SEARCH_URL as p, DEFAULT_OPENAI_CODEX_SEARCH_MODE as pt, SUPPORTED_NODE_RANGE as q, apply as r, OPENAI_CODEX_PROXY_CANDIDATE_LIMIT as rt, OPENAI_CODEX_SEARCH_MODEL_REQUEST_EVENT as s, detectOpenAICodexProxies as st, Config as t, OPENAI_CODEX_PROXY_TEST_PATH as tt, probeCodexAutoReview as u, DEFAULT_OPENAI_CODEX_PROXY_URL as ut, OPENAI_CODEX_IMAGE_MAX_ERROR_BYTES as v, isValidOpenAICodexContextWindowOverrides as vt, OPENAI_CODEX_TRANSPORT_SERVICE as w, resolveOpenAICodexSettings as wt, OPENAI_CODEX_IMAGE_REQUEST_TIMEOUT_MS as x, isValidOpenAICodexProxyUrl as xt, OPENAI_CODEX_IMAGE_MAX_RESPONSE_BYTES as y, isValidOpenAICodexImageModelHint as yt, COMPATIBILITY_CONTRACT as z, publicAuthError as zt };
