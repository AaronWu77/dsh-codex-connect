...
const Config = z.object({
	...
	maxTokensOverrides: z.transform(z.union([z.const(void 0), z.dict(z.union([z.const(null), z.number()]))]), parseOpenAICodexMaxTokensOverrides),
	contextWindowMode: z.union(["default", "extended"]).default(DEFAULT_OPENAI_CODEX_CONTEXT_WINDOW_MODE),
	modelCatalogClientVersion: z.transform(z.string(), parseOpenAICodexModelCatalogClientVersion).default(DEFAULT_OPENAI_CODEX_MODEL_CATALOG_CLIENT_VERSION),
