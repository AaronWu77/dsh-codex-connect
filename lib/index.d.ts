...
declare class OpenAICodexCredentialStore implements CredentialStore {
   ...
   */
  captureAccount(selectedAccountKey: string): Promise<CapturedOpenAICodexAccount>;
...
declare const SUPPORTED_DSH_PLUGIN_API_VERSIONS: readonly ["0.1.2-rc.1", "0.1.5-alpha.1", "0.1.5-rc.1", "0.1.5-rc.2", "0.1.7-rc.1"];
...
declare const COMPATIBILITY_CONTRACT: {
  ...
  readonly dshPluginApi: {
    ...
    readonly versions: readonly ["0.1.2-rc.1", "0.1.5-alpha.1", "0.1.5-rc.1", "0.1.5-rc.2", "0.1.7-rc.1"];
...
declare function isValidOpenAICodexMaxTokensOverrides(value: unknown): value is Readonly<Record<string, number | null>>;
...
interface OpenAICodexSettingsInput extends Partial<Omit<OpenAICodexSettingsConfig, 'contextWindowOverrides' | 'maxTokensOverrides'>> {
...
declare const Config: z<Config, VolatileConfig>;
/**
