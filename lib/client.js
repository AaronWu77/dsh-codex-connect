window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function UsageSummary({ usage, quotaError, onOpen, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: bodyStyle,
						children: windows.length === 0 ? t("quotaUnavailable") : windows.map((window) => [windowLabel(window.windowSeconds, t), t("percentRemaining", { percent: formatPercent$1(window.remainingPercent) })].join(" ")).join(" · ")
		...
		function OpenAICodexSettings({ t, configScope, account, onOpenUsage, embedded = false, accountOnly = false }) {
		...
		function OpenAICodexPluginCard({ t, configScope, account, onOpenUsage }) {
		...
		*/
		...
		function figuresOf(usage) {
			...
			if (windows.length === 0 && credits === void 0) return null;
			return {
				windows,
		...
		function sameAccount(left, right) {
			return left.accountKey === right.accountKey && left.label === right.label && left.active === right.active && (left.unavailable ?? false) === (right.unavailable ?? false) && sameWindows(left.windows, right.windows) && sameCredits(left.credits, right.credits);
		}
		/**
