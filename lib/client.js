window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function OpenAICodexSettings({ t, configScope, updater, account, onOpenUsage, embedded = false, accountOnly = false }) {
		...
		function OpenAICodexPluginCard({ t, configScope, updater, account, onOpenUsage }) {
