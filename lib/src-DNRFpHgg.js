...
function createOpenAICodexProfile(provider, fastMode, proxyManager, resolveProxyUrl, contextWindowOverrides, maxTokensOverrides, route = OPENAI_CODEX_PRIMARY_ROUTE, layer, resolveOnPayloadFields) {
	const routedProvider = withOpenAICodexRouteId(applyOpenAICodexOverrides(layer === void 0 ? provider : applyOpenAICodexLiveCatalog(provider, layer.live, layer.mode).provider, contextWindowOverrides, maxTokensOverrides), route.routeId);
	return {
...
*/
function applyOpenAICodexOverrides(provider, contextWindowOverrides, maxTokensOverrides) {
